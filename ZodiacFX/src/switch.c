...
uint8_t spibuffer[1];
struct ofp10_port_stats phys10_port_stats[MAX_PORTS];
struct ofp13_port_stats phys13_port_stats[MAX_PORTS];
uint8_t port_status[MAX_PORTS];
uint8_t last_port_status[MAX_PORTS];
